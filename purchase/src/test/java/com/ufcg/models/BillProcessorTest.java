...
public class BillProcessorTest extends TestCase {
  ...
  public void testProcessBillAllBillsMatch() {
    Statement statement =
        BillProcessor.processBill(bill, bills, "John Doe", PaymentMethod.BANK_SLIP);
  ...
  public void testProcessBillMixedPaymentMethods() {
    ...
    Statement statement =
        BillProcessor.processBill(bill, mixedBills, "John Doe", PaymentMethod.BANK_TRANSFER);
  ...
  public void testProcessBillInsufficientPayments() {
    List<Bill> insufficientBills =
        Collections.singletonList(
            new Bill(validDate, 700.0, "12345678901234567890123456789012345678901234"));

    Statement statement =
        BillProcessor.processBill(bill, insufficientBills, "John Doe", PaymentMethod.BANK_SLIP);
  ...
  public void testProcessBillInvalidPaymentDates() {
    ...
    Statement statement =
        BillProcessor.processBill(bill, invalidDateBills, "John Doe", PaymentMethod.BANK_SLIP);
  ...
  public void testProcessBillCreditCardLatePayment() {
    List<Bill> creditCardBills =
        Arrays.asList(new Bill(validDate, 700.0, "12345678901234567890123456789012345678901234"));

    Statement statement =
        BillProcessor.processBill(bill, creditCardBills, "John Doe", PaymentMethod.CREDIT_CARD);
  ...
  public void testProcessBillBankSlipLatePayment() {
    List<Bill> bankSlipBills =
        Collections.singletonList(
            new Bill(validDate, 700.0, "12345678901234567890123456789012345678901234"));

    Statement statement =
        BillProcessor.processBill(bill, bankSlipBills, "John Doe", PaymentMethod.BANK_SLIP);
